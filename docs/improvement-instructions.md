...
```
実装タスク:
- [ ] 匿名ログインにCAPTCHA（hCaptcha/Turnstile）を追加
  - 理由: ニックネームだけのログインはBot作成が容易すぎる
  - GameWithも新規24時間制限で対策している
- [ ] 同一IPからの短時間大量アカウント作成を検知・ブロック
